...
export const tools: Tool[] = [
  {
    ...
    fullDescription: 'ChatGPT is OpenAI\'s revolutionary conversational AI that has transformed how we interact with artificial intelligence. Built on the GPT architecture, it excels at understanding context, generating human-like responses, and assisting with a wide range of tasks from creative writing to complex problem-solving. Whether you\'re a student, professional, or curious learner, ChatGPT adapts to your needs and communication style.',
    category: 'AI Assistant',
    logo: '/logos/chatgpt.png',
    website: 'https://chat.openai.com',
    pricing: 'freemium',
    pricingDetails: {
      free: 'Access to GPT-3.5, standard response speed',
      paid: '$20/month - GPT-4 access, faster responses, priority access',
