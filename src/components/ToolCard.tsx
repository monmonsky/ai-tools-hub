...
export default function ToolCard({ tool }: ToolCardProps) {
  ...
  return (
    <div className="group relative">
      ...
      {/* Card */}
      <div className="relative bg-white/70 dark:bg-black/30 backdrop-blur-lg border border-gray-300 dark:border-purple-500/20 rounded-xl p-6 group-hover:border-gray-400 dark:group-hover:border-purple-500/40 transition-all duration-300 h-full flex flex-col">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className={`inline-block px-2 py-1 text-xs font-medium rounded-full ${getPricingColor(tool.pricing)}`}>
        ...
        <button
          ...
          className={`w-full py-2 px-4 text-sm font-medium rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 ${
            isInComparison()
